# Generated by Django 3.0 on 2020-06-30 11:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='books', to='api.Publish')),
            ],
            options={
                'verbose_name': '图书',
